...
instagram_api = API(
    api_root_url="https://api.instagram.com/v1/", params=default_params, json_encode_body=True
)
instagram_api.add_resource(resource_name="users", resource_class=UserResource)
print(
    "instagram_api.users.search={!r}".format(instagram_api.users.search(params={"q": "allissonazevedo"}).body)
)
