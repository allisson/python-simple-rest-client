...
def test_resource_response_body(content_type, response_body, expected_response_body, reqres_resource):
    ...
    responses.add(responses.GET, url, body=response_body, status=200, content_type=content_type)
...
async def test_asyncresource_response_body(
    content_type, response_body, expected_response_body, reqres_async_resource
):
    url = "https://reqres.in/api/users"
    with aioresponses() as mock_response:
